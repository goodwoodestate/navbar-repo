    ...
    return (
        <Accordion transition={{duration: "300ms", timingFunction: "cubic-bezier(0, 0, 0.2, 1)"}}>
            <AccordionItem>
                {({open}) => (
                    <>
                        <AccordionHeader className="w-full flex justify-between items-center text-white mt-2 text-3xl">
                            <span className='text-[1.25rem]'>Navigation Dropdown</span>
                        ...
                        <AccordionBody>
                            <div className="p-5 text-3xl text-nav-second-text">
                                <div className='text-base'>Subitem</div>
                            </div>
                        </AccordionBody>
                    </>
                )}
